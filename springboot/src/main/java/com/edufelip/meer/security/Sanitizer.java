...
public final class Sanitizer {
  ...
  /**
   * Light-weight input sanitizer to strip control chars and basic script tags. Does not HTML-escape
   * (so stored text stays readable) but removes common XSS vectors.
   */
