...
public class StoreSearchController {
    ...
    public StoreSearchController(ThriftStoreRepository thriftStoreRepository,
    ...
    public PageResponse<ThriftStoreDto> search(
        ...
        var ids = result.getContent().stream().map(com.edufelip.meer.core.store.ThriftStore::getId).toList();
