...
public class AuthController {
  ...
  public ResponseEntity<AuthDtos.AuthResponse> loginWithGoogle(
      @RequestBody AuthDtos.GoogleLoginRequest body,
  ...
  @PostMapping("/apple")
  public ResponseEntity<AuthDtos.AuthResponse> loginWithApple(
      @RequestBody AuthDtos.AppleLoginRequest body) {
  ...
  @ExceptionHandler({
    ...
    InvalidAppleTokenException.class,
